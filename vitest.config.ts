    ...
    projects: [
      {
        ...
        test: {
          ...
          exclude: [
            ...
            "tests/unit/web/late-submission-fields.test.ts",
            "tests/unit/web/workspace-timer.test.ts",
            ...
            "tests/unit/web/back-link.test.ts",
      ...
      },
      {
        ...
        test: {
          ...
          include: [
            ...
            "tests/component/web/assessment-manage-tabs.test.ts",

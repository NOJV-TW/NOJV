...
| `worker.sandbox.{cpuRequest,caseCpuRequest,cpuLimit,memoryRequest,memoryLimit}`     | 500m / 100m / 1 · 256Mi / 512Mi                                                 | compile/materialize versus testcase requests; per-sandbox Job hints                                                                                                                                     |
| `worker.sandbox.{maxParallelCases,runtimeClassName}`                                | 20 / gvisor                                                                     | maximum testcase fan-out and required sandbox runtime                                                                                                                                                   |

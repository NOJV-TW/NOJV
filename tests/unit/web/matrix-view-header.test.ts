...
vi.mock("$lib/components/features/course/submissions/MatrixToolbar.svelte", async () => ({
  default: (await import("./fixtures/empty-component.svelte")).default,
}));
vi.mock("$lib/components/features/course/submissions/MatrixTable.svelte", async () => ({
  default: (await import("./fixtures/empty-component.svelte")).default,
}));

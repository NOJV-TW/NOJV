...
- Modify: `packages/application/src/submission/judge-lifecycle.ts`
- Modify: `packages/application/src/submission/judge-context.ts` (current owner of `getJudgeContext`)

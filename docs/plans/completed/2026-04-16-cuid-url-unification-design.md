...
| Assignment detail (management + overview) | `/courses/[courseId]/assignments/[assignmentId]`    | `/assignments/[assessmentId]` _(role-gated tabs)_  |
| Exam detail (management + overview)       | `/courses/[courseId]/exams/[examId]`                | `/exams/[examId]` _(role-gated tabs)_              |

...
- **MinIO credential exposure**: Default MinIO credentials (`minioadmin/minioadmin`) used in development. _Mitigation_: Development only. Production uses different S3-compatible service with proper credentials from Secret Manager.

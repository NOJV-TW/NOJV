...
- Problems: authorize against the actor and the problem resource, not platform role alone.
  ...
  - Co-editing grants no ownership operations, public-publication consent, bundle export, cross-course sharing or access to unrelated submissions. Private reference solutions have their own read gate. See [Database — Problem Ownership](../architecture/DATABASE.md#problem-ownership-and-course-library).

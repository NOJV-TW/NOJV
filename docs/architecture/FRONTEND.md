...
| `/api/problems/advanced-scaffold`                             | GET                | Stream the advanced-mode starter project zip (dev-only)                                        |
...
| `/api/problems/[id]/advanced-package`                         | POST               | Upload advanced-mode package zip and prebuild judge images (dev-only)                          |

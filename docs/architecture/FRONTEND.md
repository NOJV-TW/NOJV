...
| `/problems`                                          | Problem listing with filters (difficulty, tags, status) and Public / My Problems / All Problems tabs; eligible staff can fork published public problems into private drafts                                                                                                                                 |
...
| `/admin/courses`                                     | Platform-wide course list (admin only; not enrollment-scoped)                                                                                                                                                                                                                                               |
| `/admin/assignments`                                 | Platform-wide assignment list (admin only; not enrollment-scoped)                                                                                                                                                                                                                                           |
| `/admin/exams`                                       | Platform-wide exam list (admin only; not enrollment-scoped)                                                                                                                                                                                                                                                 |
| `/admin/contests`                                    | Platform-wide contest list (admin only)                                                                                                                                                                                                                                                                     |
...
| `/api/problems/[id]/fork`                                     | POST               | Create an independent private fork of a published public problem; returns `{ id }`             |

...
| `/problems/[problemId]/editorials`                   | Editorial post list for a problem (AC-gated visibility; author/admin exempt)                                                                                                                                                                                                                                |
| `/problems/[problemId]/editorials/new`               | Write a new editorial post                                                                                                                                                                                                                                                                                  |
| `/problems/[problemId]/editorials/[postId]`          | Editorial article — markdown body, votes, reports, threaded comments                                                                                                                                                                                                                                        |
| `/problems/[problemId]/editorials/[postId]/edit`     | Edit an editorial post (author or admin)                                                                                                                                                                                                                                                                    |
| `/problems/[problemId]/discussions`                  | Discussion post list for a problem (any signed-in user; blocked during active exams/contests)                                                                                                                                                                                                               |
| `/problems/[problemId]/discussions/new`              | Start a new discussion post                                                                                                                                                                                                                                                                                 |
| `/problems/[problemId]/discussions/[postId]`         | Discussion article — markdown body, votes, reports, threaded comments                                                                                                                                                                                                                                       |
| `/problems/[problemId]/discussions/[postId]/edit`    | Edit a discussion post (author or admin)                                                                                                                                                                                                                                                                    |
...
| `/admin/editorial-reports`                           | Review reported editorials                                                                                                                                                                                                                                                                                  |

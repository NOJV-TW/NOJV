...
| `NotificationPreference`     | Per-user email notification channel opt-ins + lead-day settings + link-confirmed notification address (`email`, `emailVerifiedAt`)                                                                                             | `schema/notification.prisma`  |

...
| Product specification      | B+    | PRODUCT_SENSE.md + per-feature acceptance specs under `docs/specs/` (assignments, exams, contests, copy-course, proctoring).              | Backfill specs for plagiarism, editorials, dashboard.  |

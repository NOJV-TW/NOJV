...
<GlassPanel class={cn("overflow-hidden", className)}>
  <div class="flex items-center gap-2 overflow-x-auto border-b border-border-subtle px-3 py-2">
    <div role="tablist" aria-label={label} class="flex items-center gap-1">

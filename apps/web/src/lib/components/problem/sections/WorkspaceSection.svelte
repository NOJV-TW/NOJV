<script lang="ts">
  ...
  import WorkspaceModeSection, {
    type WorkspaceMode
  } from "$lib/components/problem/workspace/WorkspaceModeSection.svelte";
  import WorkspaceRuntimeSection from "$lib/components/problem/workspace/WorkspaceRuntimeSection.svelte";
  import WorkspaceLanguagesSection from "$lib/components/problem/workspace/WorkspaceLanguagesSection.svelte";
  import WorkspaceFilesSection from "$lib/components/problem/workspace/WorkspaceFilesSection.svelte";
  import WorkspaceSaveBar from "$lib/components/problem/workspace/WorkspaceSaveBar.svelte";
  import type { WorkspaceFile } from "$lib/components/problem/workspace/WorkspaceFileEditor.svelte";
